  ...
  const packages = [
    {
      ...
      duration: '30 minutes',
      price: 'Free',
      description: 'Perfect for first-time clients. We\'ll discuss your goals and see if we\'re a good fit.',
      features: ['Goal assessment', 'Pattern identification', 'Action plan outline', 'No commitment required']
    },
    {
      id: 'coaching',
      ...
      duration: '60 minutes',
      price: '$150',
      description: 'Comprehensive coaching session focused on breaking patterns and building authentic life.',
      features: ['Deep pattern work', 'Personalized strategies', 'Accountability framework', 'Follow-up support']
    },
    {
      id: 'intensive',
      ...
      duration: '90 minutes',
      price: '$200',
      description: 'Extended session for complex challenges or rapid breakthrough work.',
      features: ['Extended deep work', 'Multiple pattern focus', 'Comprehensive action plan', 'Priority support']
    }
  ];
